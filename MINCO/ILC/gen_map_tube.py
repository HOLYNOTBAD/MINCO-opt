...
if __name__ == '__main__':
    ...
    parser.add_argument('--out', '-o', help='输出 npz 路径', default='MINCO/ILC/map_manage/tube_corridor.npz')
    parser.add_argument('--png', help='可视化 png 路径（可选）', default='MINCO/ILC/map_manage/tube_corridor.png')
